...
void crearMenu(){	
	...
	glutAddMenuEntry("Imagen 1",2);
	glutAddMenuEntry("Imagen 2",3);
	glutAddMenuEntry("Imagen 3",4);
	glutAddMenuEntry("Imagen 4",5);
	glutAddMenuEntry("Imagen 5",6);
	glutAddMenuEntry("Imagen 6",7);
	menu_id = glutCreateMenu(menu);
	glutAddSubMenu("Texturas",sub_menu_id);
...
void inicializar() {
        ...
        if(!cargarTGA("2A.tga", &texturas[0])) { 
...
void inicializar1(){
        ...
        glHint(GL_PERSPECTIVE_CORRECTION_HINT, GL_NICEST);      // Esto hace que opengl calcule las perspectivas de la mejor forma, quita un poco de rendimiento, pero hace que las perspectivas se vean un poco mejor.
		glEnable(GL_TEXTURE_2D);
        if(!cargarTGA("2B.tga", &texturas[0])) { 
                printf("Error cargando textura\n");
		exit(0); // Cargamos la textura y chequeamos por errores
		}
}
...
void inicializar2(){
        ...
        glHint(GL_PERSPECTIVE_CORRECTION_HINT, GL_NICEST);      // Esto hace que opengl calcule las perspectivas de la mejor forma, quita un poco de rendimiento, pero hace que las perspectivas se vean un poco mejor.
		glEnable(GL_TEXTURE_2D);
        if(!cargarTGA("2C.tga", &texturas[0])) { 
                printf("Error cargando textura\n");
		exit(0); // Cargamos la textura y chequeamos por errores
		}
}
...
void inicializar3(){
        ...
        glHint(GL_PERSPECTIVE_CORRECTION_HINT, GL_NICEST);      // Esto hace que opengl calcule las perspectivas de la mejor forma, quita un poco de rendimiento, pero hace que las perspectivas se vean un poco mejor.
		glEnable(GL_TEXTURE_2D);
        if(!cargarTGA("2D.tga", &texturas[0])) { 
                printf("Error cargando textura\n");
		exit(0); // Cargamos la textura y chequeamos por errores
		}
}
...
void inicializar4(){
        ...
        glHint(GL_PERSPECTIVE_CORRECTION_HINT, GL_NICEST);      // Esto hace que opengl calcule las perspectivas de la mejor forma, quita un poco de rendimiento, pero hace que las perspectivas se vean un poco mejor.
		glEnable(GL_TEXTURE_2D);
        if(!cargarTGA("2E.tga", &texturas[0])) { 
                printf("Error cargando textura\n");
		exit(0); // Cargamos la textura y chequeamos por errores
		}
}
...
void inicializar5(){
        ...
        glHint(GL_PERSPECTIVE_CORRECTION_HINT, GL_NICEST);      // Esto hace que opengl calcule las perspectivas de la mejor forma, quita un poco de rendimiento, pero hace que las perspectivas se vean un poco mejor.
		glEnable(GL_TEXTURE_2D);
        if(!cargarTGA("2F.tga", &texturas[0])) { 
                printf("Error cargando textura\n");
		exit(0); // Cargamos la textura y chequeamos por errores
		}
}
...
void inicializar6(){
        ...
        glHint(GL_PERSPECTIVE_CORRECTION_HINT, GL_NICEST);      // Esto hace que opengl calcule las perspectivas de la mejor forma, quita un poco de rendimiento, pero hace que las perspectivas se vean un poco mejor.
		glEnable(GL_TEXTURE_2D);
        if(!cargarTGA("2G.tga", &texturas[0])) { 
                printf("Error cargando textura\n");
		exit(0); // Cargamos la textura y chequeamos por errores
		}
}
...
void cambiarTamano(int largo, int ancho) {
		...
		glLoadIdentity();		// Se resetea la matriz
        gluLookAt( 2.0, 1.0, 0.0,       // Hacia donde miramos
